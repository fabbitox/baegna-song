const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    ...
    {"singer": "김현정", "songs": ["그녀와의이별", "멍"]}, {"singer": "나비/Navi", "songs": ["길에서"]},
    {"singer": "남규리", "songs": ["깊은밤을날아서"]}, {"singer": "노라조", "songs": ["형"]},
    {"singer": "노을", "songs": ["늦은밤너의집앞골목길에서", "청혼"]},
    ...
    {"singer": "럼블피쉬", "songs": ["비와당신"]}, {"singer": "리지", "songs": ["쉬운여자아니에요"]},
    ...
    {"singer": "박보람(동물원)", "songs": ["혜화동(쌍문동)"]}, {"singer": "박효신", "songs": ["사랑한후에"]}, {"singer": "백아연", "songs": ["이럴거면그러지말지"]},
    ...
    {"singer": "보아/BoA", "songs": ["Every Heart(이누야샤 4기 OST)/에브리하트"]},
    ...
    {"singer": "소찬휘", "songs": ["일엽락", "Tears/티어스/티얼스"]},
    ...
    {"singer": "씨야/SeeYa", "songs": ["구두", "그사람이나를사랑해요", "눈물의여왕", "미워요", "미친사랑의노래", "사랑의인사", "슬픈발걸음(구두2)", "얼음인형", "여인의향기", "정", "Promise U/프로미스유", "The Day/더데이/브라운아이드걸스", "The Last/더라스트"]},
    ...
    {"singer": "유주", "songs": ["호랑수월가(나와호랑이님 OST)"]}, {"singer": "유해준", "songs": ["나에게그대만이", "내소중한사람에게"]},
    {"singer": "윤미래", "songs": ["시간이흐른뒤", "ALWAYS/얼웨이즈/올웨이즈"]}, {"singer": "윤종신", "songs": ["좋니"]},
    {"singer": "윤하", "songs": ["기다리다", "비밀번호486", "오늘헤어졌어요", "혜성"]}, {"singer": "이루", "songs": ["까만안경"]},
    {"singer": "이브", "songs": ["너그럴때면"]}, {"singer": "이소라", "songs": ["기억해줘", "바람이분다", "제발", "처음느낌그대로"]},
    {"singer": "이수영", "songs": ["굿바이", "덩그러니", "라라라", "사랑하면할수록", "얼마나좋을까", "여전히입술을깨물죠", "휠릴리", "Grace/그레이스", "I Believe/아이빌리브"]},
    ...
    {"singer": "지아", "songs": ["가끔", "감기때문에", "그대만보여요", "그런다면서", "그런줄알았어", "그립습니다", "난행복해", "낡은옷", "너를기억한다", "누군가의무엇이되어", "눈물", "더만나봤자뭐해", "먼발치", "물끄러미", "물론", "바이올린", "사랑만알아서", "사랑해미안해", "술한잔해요", "술한잔해요오늘", "엄마미안해요", "우두커니", "웃게해줄게", "웃어줄래", "웃음만", "인형", "터질것같아", "헤어진첫날", "The Day/더데이", "Only One/온리원"]},
    {"singer": "차지연", "songs": ["그대는어디에", "살다보면"]},
...
const newUpdate = ["김신우 - 귀거래사", "김호중 - 고맙소", "나비 - 길에서", "박효신 - 사랑한 후에", "보아 - Every Heart(이누야샤 4기 OST)", "브라운아이드걸스, 씨야 - The Day", "소찬휘 - Tears", "유해준 - 내 소중한 사람에게", "이수영 - 덩그러니", "지아 - 터질 것 같아", "차지연 - 그대는 어디에", "패티 김 - 이별"];
