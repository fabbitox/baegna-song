const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    ...
    {"singer": "마마무", "songs": ["넌 is 뭔들", "데칼코마니"]},
...
const mrTrot = [{"singer": "김호중", "songs": ["너나나나", "태클을걸지마", "할무니"]}, {"singer": "사랑의콜센타", "songs": ["날보러와요"]},
...
const old = [{"singer": "강수지", "songs": ["시간속의향기"]}, {"singer": "구창모", "songs": ["희나리"]},
    ...
    {"singer": "서울시스터즈(방실이)", "songs": ["첫차"]}, {"singer": "석미경", "songs": ["물안개"]},
    {"singer": "별", "songs": ["12월32일"]}, {"singer": "소리새", "songs": ["그대그리고나"]},
    {"singer": "양수경", "songs": ["당신은어디있나요", "사랑은창밖에빗물같아요", "이별의끝은어디인가요"]},
    {"singer": "양희은", "songs": ["사랑그쓸쓸함에대하여", "이루어질수없는사랑", "하얀목련"]},
    {"singer": "우순실", "songs": ["잃어버린우산"]}, {"singer": "윤도현", "songs": ["가을우체국앞에서(슬기로운의사생활 시즌2 OST)"]},
    ...
    {"singer": "임희숙", "songs": ["내하나의사람은가고"]}, {"singer": "장덕", "songs": ["뒤늦은후회", "소녀와가로등"]},
    ...
    {"singer": "채은옥", "songs": ["빗물"]}, {"singer": "햇빛촌", "songs": ["유리창엔비"]},
