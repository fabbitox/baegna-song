const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    ...
    {"singer": "강민경", "songs": ["사랑해서그래"]}, {"singer": "거미", "songs": ["그대돌아오면", "그대라서", "기억해줘요내모든날과그때를", "날그만잊어요", "내생각날거야(Narr. 이시영)", "너의하루는좀어때", "눈꽃", "아니", "어른아이", "죽어도사랑해", "지워져", "친구라도될걸그랬어", "통증", "혼자만하는사랑", "You are my everything/유아마이에브리띵"]},
    ...
    {"singer": "조항조", "songs": ["가지마", "후"]}, {"singer": "지동국", "songs": ["돌아가는길"]}, {"singer": "지아", "songs": ["가끔", "감기때문에", "그대만보여요", "그런다면서", "그런줄알았어", "그립습니다", "난행복해", "낡은옷", "너를기억한다", "누군가의무엇이되어", "눈물", "더만나봤자뭐해", "먼발치", "물끄러미", "물론", "뭉클", "바이올린", "사랑만알아서", "사랑해미안해", "술한잔해요", "술한잔해요오늘", "엄마미안해요", "우두커니", "웃게해줄게", "웃어줄래", "웃음만", "인형", "터질것같아", "헤어진첫날", "The Day/더데이", "Only One/온리원"]},
    ...
    {"singer": "SG워너비", "songs": ["살다가"]}, {"singer": "Sondia/손디아", "songs": ["어른", "첫사랑(어쩌다 발견한 하루 OST part 3)", "혼잣말"]}, {"singer": "TWICE/트와이스", "songs": ["Dance The Night Away/댄스더나잇어웨이"]},
...
const newUpdate = ["거미 - 내 생각날 거야(Narr. 이시영)", "김지애 - 물레야", "조은새 - 나이트", "지아 - 뭉클", "Sondia - 첫사랑(어쩌다 발견한 하루 OST part 3)"];
