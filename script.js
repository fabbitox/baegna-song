const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    ...
    {"singer": "럼블피쉬", "songs": ["비와당신"]}, {"singer": "리즈/Leeds", "songs": ["그댄행복에살텐데"]}, {"singer": "리지", "songs": ["쉬운여자아니에요"]},
    ...
    {"singer": "정경화", "songs": ["지상에서영원으로"]}, {"singer": "정은지", "songs": ["그대라구요", "하늘바라기"]}, {"singer": "정준일", "songs": ["안아줘"]},
...
const trot = [{"singer": "강민주", "songs": ["회룡포"]}, {"singer": "강진", "songs": ["땡벌", "붓"]}, {"singer": "강혜연", "songs": ["와요와요"]},
    ...
    {"singer": "이혜리", "songs": ["모르나봐", "자갈치아지매"]}, {"singer": "임주리", "songs": ["립스틱짙게바르고"]}, {"singer": "장윤정", "songs": ["꽃", "너떠난후에", "다시한번", "당신편", "돼지토끼", "목포행완행열차", "바람길", "반창고", "버팀목", "벚꽃길", "불나비", "사랑아", "사랑참", "세월아", "송인", "애가타", "약속", "어머나", "어부바", "옆집누나", "올래", "운명에게", "이정표", "장윤정트위스트", "좋은당신", "짠짜라", "첫사랑", "초혼", "케세라세라", "콩깍지", "해바라기"]},
...
const newUpdate = ["강혜연 - 와요 와요", "김규랑 - 하지마요", "엄정화 - 하늘만 허락한 사랑", "요요미 - 주연배우", "이승철 - 서쪽 하늘", "자우림 - 있지", "홍진영 - 내사랑"];
