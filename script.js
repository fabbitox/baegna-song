const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    ...
    {"singer": "다비치", "songs": ["거북이", "그냥안아달란말야", "그대니까요", "꿈처럼내린", "나의오랜연인에게", "남자도우나요", "너라서", "너없는시간들", "너에게못했던내마지막말은", "또운다또", "모르시나요", "미워도사랑하니까", "사고쳤어요", "사랑과전쟁", "시간아멈춰라", "여성시대", "오늘도그리워그리워", "오로지그대", "이사랑", "화이트/WHITE", "8282"]},
...
const trot = [{"singer": "강민주", "songs": ["회룡포"]}, {"singer": "강진", "songs": ["땡벌", "붓"]},
    ...
    {"singer": "요요미", "songs": ["이오빠뭐야"]}, {"singer": "우연이", "songs": ["우연히"]}, {"singer": "윙크", "songs": ["얼쑤"]}, 
...
const mrTrot = [{"singer": "김호중", "songs": ["고맙소", "너나나나", "살았소", "태클을걸지마", "할무니"]},
    ...
    {"singer": "임영웅", "songs": ["가슴은알죠/나예원", "바램", "별빛같은나의사랑아", "보랏빛엽서", "사랑은늘도망가/이문세", "사랑이이런건가요", "어느날문득", "이제나만믿어요", "일편단심민들레야"]},
...
const newUpdate = ["다비치 - 꿈처럼 내린", "박기영 - 마지막 사랑", "원더걸스 - Nobody", "윙크 - 얼쑤", "이보람(씨야) - 처음 그 자리에(풀하우스 OST)", "임영웅 - 가슴은 알죠(원곡 나예원)", "임형주 - 천개의 바람이 되어", "장범준 - 흔들리는 꽃들 속에서 네 샴푸향이 느껴진거야", "The One(더원) - 사랑아"];
