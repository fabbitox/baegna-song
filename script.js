const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    {"singer": "가비엔제이", "songs": ["그래도살아가겠지", "널사랑하는데", "눈사람", "반대편에서서", "연애소설", "이별주의보", "절애", "해바라기", "Everyday/에브리데이", "Happiness/해피니스", "LOVE ALL/러브올"]},
    {"singer": "강민경", "songs": ["사랑해서그래"]},
    {"singer": "거미", "songs": ["그대돌아오면", "그대라서", "기억해줘요내모든날과그때를", "날그만잊어요", "너의하루는좀어때", "눈꽃", "아니", "어른아이", "죽어도사랑해", "지워져", "친구라도될걸그랬어", "통증", "혼자만하는사랑", "You are my everything/유아마이에브리띵"]},
    {"singer": "공소원", "songs": ["모래알사랑"]}, {"singer": "김길중", "songs": ["사랑했지만"]},
    {"singer": "김나영", "songs": ["꺼내본다", "니가없다면", "솔직하게말해서나", "헤어질수밖에", "홀로"]},
    {"singer": "김대명", "songs": ["가을우체국앞에서(슬기로운의사생활 시즌2 OST)"]},
    {"singer": "김동희", "songs": ["그대를그대를", "사랑은하지마", "사랑을몰랐죠", "썸데이", "이런다고", "이제야", "헤어질땐말없이"]},
    {"singer": "김범수", "songs": ["끝사랑"]}, {"singer": "김보경", "songs": ["Suddenly/서든리(시티헌터 OST)"]}, {"singer": "김아중", "songs": ["마리아"]},
    {"singer": "김윤아(자우림)", "songs": ["길(시그널 OST)", "스물다섯스물하나", "야상곡"]}, {"singer": "김진호", "songs": ["가족사진"]},
    {"singer": "김현정", "songs": ["그녀와의이별", "멍"]}, {"singer": "남규리", "songs": ["깊은밤을날아서"]},
    {"singer": "노라조", "songs": ["형"]}, {"singer": "노을", "songs": ["늦은밤너의집앞골목길에서", "청혼"]},
    {"singer": "도원경", "songs": ["다시사랑한다면"]}, {"singer": "도은영", "songs": ["그래도사랑해요"]},
    {"singer": "다비치", "songs": ["거북이", "그냥안아달란말야", "그대니까요", "나의오랜연인에게", "남자도우나요", "너라서", "너없는시간들", "너에게못했던내마지막말은", "또운다또", "모르시나요", "미워도사랑하니까", "사고쳤어요", "사랑과전쟁", "시간아멈춰라", "여성시대", "오늘도그리워그리워", "오로지그대", "이사랑", "화이트/WHITE", "8282"]},
    {"singer": "더리슨(솔지x김나영x케이시x승희xHYNN)/박혜원", "songs": ["느린이별"]},
    {"singer": "란", "songs": ["어쩌다가"]}, {"singer": "럼블피쉬", "songs": ["비와당신"]},
    {"singer": "리지", "songs": ["쉬운여자아니에요"]},
    {"singer": "린", "songs": ["곰인형", "돌팔매/사랑의콜센타", "알아요(연모 OST)", "사랑했잖아", "시간을거슬러", "실화", "이별살이", "자기야여보야사랑아"]},
    {"singer": "마골피", "songs": ["비행소녀"]}, {"singer": "마마무", "songs": ["넌 is 뭔들", "데칼코마니"]},
    {"singer": "마야", "songs": ["나를외치다", "못다핀꽃한송이", "진달래꽃"]}, {"singer": "마크툽", "songs": ["오늘도빛나는너에게"]},
    {"singer": "먼데이키즈", "songs": ["그대여"]}, {"singer": "모세", "songs": ["사랑인걸"]},
    {"singer": "바이걸", "songs": ["내이름은여자"]}, {"singer": "박미경", "songs": ["기억속의먼그대에게", "민들레홀씨되어"]},
    {"singer": "박보람(동물원)", "songs": ["혜화동(쌍문동)"]}, {"singer": "백아연", "songs": ["이럴거면그러지말지"]},
    {"singer": "백지영", "songs": ["거짓말이라도해서널보고싶어", "그대의마음", "나쁜사람(황진이 OST)", "다시는사랑하지않고이별에아파하기싫어", "사랑안해", "사랑하나면돼", "잊지말아요", "총맞은것처럼"]},
    {"singer": "버블시스터즈", "songs": ["그렇게사랑하고그렇게웃었습니다", "버블송", "애원"]},
    {"singer": "버즈", "songs": ["겁쟁이", "나에게로떠나는여행"]}, {"singer": "베이지", "songs": ["그리워그리워서", "달에지다"]},
    {"singer": "벤", "songs": ["안갯길", "여자이니까"]}, {"singer": "보보", "songs": ["늦은후회"]},
    {"singer": "빅마마", "songs": ["배반", "소리", "연", "체념", "하루만더"]}, {"singer": "서문탁", "songs": ["사랑결코시들지않는"]},
    {"singer": "서영은", "songs": ["내안의그대", "너에게로또다시", "혼자가아닌나"]},
    {"singer": "소녀시대", "songs": ["다시만난세계", "소녀시대", "Kissing You/키싱유"]}, {"singer": "수지", "songs": ["겨울아이"]},
    {"singer": "소찬휘", "songs": ["일엽락"]},
    {"singer": "소향", "songs": ["가슴만알죠", "나언젠간떠날거야(모아나 OST)", "바람의노래/조용필", "오직단하나(마의 OST)"]},
    {"singer": "솔지", "songs": ["계절의끝에서"]},
    {"singer": "송하예", "songs": ["니소식", "새사랑"]}, {"singer": "송이한", "songs": ["밝게빛나는별이되어비춰줄게"]},
    {"singer": "신승훈", "songs": ["미소속에비친그대"]}, {"singer": "신예영", "songs": ["우리왜헤어져야해"]},
    {"singer": "신현희와김루트", "songs": ["오빠야"]},
    {"singer": "심규선", "songs": ["밤의정원", "부디", "소로", "아라리", "야래향", "어떤날도어떤말도", "월령"]},
    {"singer": "씨야", "songs": ["구두", "그사람이나를사랑해요", "눈물의여왕", "미워요", "미친사랑의노래", "사랑의인사", "슬픈발걸음(구두2)", "얼음인형", "여인의향기", "정", "Promise U/프로미스유", "The Last/더라스트"]},
    {"singer": "아이오아이/IOI", "songs": ["소나기"]}, {"singer": "아이유/IU", "songs": ["가을아침", "개여울", "나만몰랐던이야기", "내손을잡아", "너의의미", "무릎", "미리크리스마스", "미아", "밤편지", "사랑이지나가면", "이름에게", "있잖아", "잔소리", "좋은날", "Love poem/러브포엠", "Rain Drop/레인드롭", "Someday/썸데이"]},
    ...
    {"singer": "유미", "songs": ["별", "사랑은언제나목마르다"]}, {"singer": "유성은", "songs": ["그대꽃"]},
    {"singer": "유정석", "songs": ["질풍가도"]}, {"singer": "유재하", "songs": ["사랑하기때문에"]},
    {"singer": "유주", "songs": ["호랑수월가(나와호랑이님 OST)"]}, {"singer": "유해준", "songs": ["나에게그대만이"]},
    {"singer": "윤미래", "songs": ["시간이흐른뒤", "ALWAYS/얼웨이즈올웨이즈"]}, {"singer": "윤종신", "songs": ["좋니"]},
    {"singer": "윤하", "songs": ["기다리다", "비밀번호486", "오늘헤어졌어요", "혜성"]}, {"singer": "이루", "songs": ["까만안경"]},
    {"singer": "이브", "songs": ["너그럴때면"]}, {"singer": "이소라", "songs": ["기억해줘", "바람이분다", "제발", "처음느낌그대로"]},
    {"singer": "이수영", "songs": ["굿바이", "라라라", "사랑하면할수록", "얼마나좋을까", "여전히입술을깨물죠", "휠릴리", "Grace/그레이스", "I Believe/아이빌리브"]},
    {"singer": "이승기", "songs": ["내여자라니까", "되돌리다", "삭제", "여행을떠나요"]}, {"singer": "이안", "songs": ["물고기자리"]},
    {"singer": "이예준", "songs": ["그날에나는맘이편했을까", "그리워그리워", "미친소리"]},
    ...
    {"singer": "제아", "songs": ["미아", "하모니/이영현"]}, {"singer": "조승우", "songs": ["꽃이피고지듯이(사도 OST)"]},
    {"singer": "조항조", "songs": ["가지마", "후"]}, {"singer": "지동국", "songs": ["돌아가는길"]},
    {"singer": "지아", "songs": ["가끔", "감기때문에", "그대만보여요", "그런다면서", "그런줄알았어", "그립습니다", "난행복해", "낡은옷", "너를기억한다", "누군가의무엇이되어", "눈물", "더만나봤자뭐해", "먼발치", "물끄러미", "물론", "바이올린", "사랑만알아서", "사랑해미안해", "술한잔해요", "술한잔해요오늘", "엄마미안해요", "우두커니", "웃게해줄게", "웃어줄래", "웃음만", "인형", "헤어진첫날", "The Day/더데이", "Only One/온리원"]},
    {"singer": "차지연", "songs": ["살다보면"]},
    {"singer": "케이시/Kassy", "songs": ["가을밤떠난너", "그때가좋았어", "너의발걸음에빛을비춰줄게", "언제나사랑해", "진심이담긴노래", "행복하니"]},
    {"singer": "코요태", "songs": ["우리의꿈(원피스)"]},
    ...
    {"singer": "페이지", "songs": ["이별이오지못하게"]}, {"singer": "폴킴", "songs": ["모든날모든순간"]},
    {"singer": "플라이 투 더 스카이", "songs": ["가슴아파도"]}, {"singer": "허각", "songs": ["언제나"]},
    {"singer": "홍진영", "songs": ["그대오는날", "눈물비", "달의그림자/클랜즈:달의그림자 OST", "따르릉", "부기맨", "사랑은꽃잎처럼", "사랑은다이러니", "사랑의배터리", "사랑의와이파이", "사랑이좋아", "산다는건", "안돼요", "엄지척", "오늘밤에", "잘가라"]},
    {"singer": "HYNN/박혜원", "songs": ["LET ME OUT/렛미아웃"]}, {"singer": "izi/이지", "songs": ["응급실/쾌걸춘향 OST"]},
    {"singer": "SG워너비", "songs": ["살다가"]}, {"singer": "Sondia/손디아", "songs": ["어른", "혼잣말"]},
    {"singer": "TWICE/트와이스", "songs": ["Dance The Night Away/댄스더나잇어웨이"]},
    {"singer": "Yarz/야즈", "songs": ["괜찮아요난(올인 OST)"]}, {"singer": "10CM/십센치", "songs": ["스토커"]}]; 
const trot = [{"singer": "강민주", "songs": ["회룡포"]}, {"singer": "강진", "songs": ["땡벌", "붓"]},
    {"singer": "곽지은", "songs": ["꽃으로"]},
    {"singer": "금잔디", "songs": ["나를살게하는사랑", "서울가살자", "신사랑고개", "엄마의노래", "여여", "오라버니", "일편단심", "지름길", "초롱새"]},
    {"singer": "김다나", "songs": ["자시삼경"]}, {"singer": "김다비", "songs": ["주라주라"]},
    {"singer": "김란영", "songs": ["가인"]}, {"singer": "김소유", "songs": ["숫자인생"]},
    {"singer": "김수희", "songs": ["남행열차", "애모"]},
    {"singer": "김연자", "songs": ["블링블링", "수은등", "아모르파티", "타이틀", "10분내로"]},
    {"singer": "김용임", "songs": ["나이야가라", "내장산", "부초같은인생", "빙빙빙", "사랑님", "열두줄", "울지마라세월아", "훨훨훨"]},
    {"singer": "김의영", "songs": ["용두산엘레지"]}, {"singer": "김의영, 윤태화", "songs": ["비익조"]},
    {"singer": "김지애", "songs": ["얄미운사람"]}, {"singer": "김태연(이태호)", "songs": ["간대요글쎄"]},
    {"singer": "김혜연", "songs": ["예쁜여우", "토요일밤에"]},
    ...
    {"singer": "박군", "songs": ["한잔해"]}, {"singer": "박상철", "songs": ["무조건", "빵빵", "자옥아", "항구의남자", "황진이"]},
    {"singer": "박현빈", "songs": ["곤드레만드레", "샤방샤방"]}, {"singer": "백난아", "songs": ["찔레꽃"]},
    {"singer": "백설희", "songs": ["봄날은간다"]}, {"singer": "서정아", "songs": ["비비각시"]},
    {"singer": "서주경", "songs": ["쓰러집니다"]}, {"singer": "서지오", "songs": ["하니하니"]},
    {"singer": "소유미", "songs": ["알랑가몰라"]}, {"singer": "송가인", "songs": ["가인이어라", "무명배우", "서울의달", "엄마아리랑", "트로트가나는좋아요"]},
    {"singer": "송대관", "songs": ["네박자", "차표한장"]}, {"singer": "숙행", "songs": ["가시리"]},
    {"singer": "신유", "songs": ["나쁜남자", "시계바늘", "일소일소일노일노", "잠자는공주"]},
    {"singer": "심수봉", "songs": ["그때그사람", "미워요", "백만송이장미", "비나리", "사랑밖엔난몰라", "젊은태양"]},
    {"singer": "안소미", "songs": ["술한잔"]}, {"singer": "LPG/엘피지", "songs": ["사랑의초인종"]},
    {"singer": "오승근", "songs": ["내나이가어때서", "있을때잘해"]}, {"singer": "오은주", "songs": ["돌팔매"]},
    {"singer": "요요미", "songs": ["이오빠뭐야"]}, {"singer": "우연이", "songs": ["우연히"]},
    {"singer": "유산슬", "songs": ["사랑의재개발", "합정역5번출구"]}, {"singer": "유지나", "songs": ["미운사내"]},
    {"singer": "유진표", "songs": ["천년지기"]}, {"singer": "윤수일", "songs": ["아파트"]},
    {"singer": "윤수현", "songs": ["꽃길", "손님온다", "천태만상"]}, {"singer": "양지은", "songs": ["붓"]},
    ...
    {"singer": "진성", "songs": ["가지마", "보릿고개", "안동역에서", "울엄마", "태클을걸지마"]},
    {"singer": "채희", "songs": ["바람의소원"]}, {"singer": "최대성", "songs": ["혹시"]},
...
const mrTrot = [{"singer": "김호중", "songs": ["너나나나", "살았소", "태클을걸지마", "할무니"]},
    ...
    {"singer": "임영웅", "songs": ["바램", "별빛같은나의사랑아", "보랏빛엽서", "사랑은늘도망가/이문세", "사랑이이런건가요", "어느날문득", "이제나만믿어요", "일편단심민들레야"]},
    {"singer": "장민호", "songs": ["내이름아시죠", "정답은없다", "파트너(with정동원)/남진"]},
    {"singer": "정동원", "songs": ["여백", "청춘", "청포도사나이", "파트너(with장민호)/남진"]}];
const old = [{"singer": "강수지", "songs": ["시간속의향기"]}, {"singer": "강승모", "songs": ["무정블루스"]},
    ...
    {"singer": "김현식", "songs": ["사랑했어요"]}, {"singer": "김혜림", "songs": ["날위한이별"]},
    {"singer": "나미", "songs": ["빙글빙글", "슬픈인연"]}, {"singer": "박성신", "songs": ["한번만더"]},
    {"singer": "박정수", "songs": ["그대품에잠들었으면"]}, {"singer": "배따라기", "songs": ["비와찻잔사이"]},
    {"singer": "뱅크", "songs": ["가질수없는너"]}, {"singer": "변진섭", "songs": ["너에게로또다시", "숙녀에게"]},
    {"singer": "별", "songs": ["12월32일"]}, {"singer": "서울시스터즈", "songs": ["첫차(방실이)", "청춘열차"]},
    {"singer": "석미경", "songs": ["물안개"]}, {"singer": "소리새", "songs": ["그대그리고나"]},
    ...
    {"singer": "이선희", "songs": ["그대손놓아요", "그중에그대를만나", "나항상그대를", "라일락이질때", "아름다운강산", "알고싶어요", "여우비", "인연", "추억의책장을넘기면"]},
    ...
    {"singer": "채은옥", "songs": ["빗물"]}, {"singer": "한경애", "songs": ["옛시인의노래"]}, {"singer": "햇빛촌", "songs": ["유리창엔비"]},
    {"singer": "혜령", "songs": ["슬픔을참는세가지방법"]},
...
const newUpdate = ["김호중 - 살았소", "애즈원 - 원하고 원망하죠", "10CM - 스토커", "강승모 - 무정 블루스", "김희재 - 별, 그대", "마골피 - 비행소녀", "솔지 - 계절의 끝에서"];
