const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    ...
    {"singer": "김윤아(자우림)", "songs": ["길(시그널 OST)", "스물다섯, 스물하나", "야상곡", "있지"]}, {"singer": "김진호", "songs": ["가족사진"]},
    ...
    {"singer": "럼블피쉬", "songs": ["비와당신"]}, {"singer": "로이킴", "songs": ["그때헤어지면돼"]}, {"singer": "리즈/Leeds", "songs": ["그댄행복에살텐데"]}, {"singer": "리지", "songs": ["쉬운여자아니에요"]},
    ...
    {"singer": "소찬휘", "songs": ["일엽락", "Tears/티어스/티얼스"]}, {"singer": "소향", "songs": ["가슴만알죠", "나언젠간떠날거야(모아나 OST)", "바람의노래/조용필", "오직단하나(마의 OST)"]},
    ...
    {"singer": "The One/더원", "songs": ["사랑아"]},  {"singer": "Yarz/야즈", "songs": ["괜찮아요난(올인 OST)"]}, {"singer": "10CM/십센치", "songs": ["스토커"]}]; 
const trot = [{"singer": "강민주", "songs": ["회룡포"]}, {"singer": "강진", "songs": ["땡벌", "마부", "붓"]}, {"singer": "강혜연", "songs": ["와요와요"]},
    ...
    {"singer": "김소유", "songs": ["숫자인생"]}, {"singer": "김수희", "songs": ["남행열차", "애모"]}, {"singer": "김연자", "songs": ["블링블링", "수은등", "아모르파티", "타이틀", "10분내로"]},
...
const newUpdate = ["강진 - 마부", "로이킴 - 그때 헤어지면 돼", "씨야(SeeYa) - 그 사람(구두 3)", "이상은 - 언젠가는", "정인 - 장마"];
