const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    ...
    {"singer": "김필", "songs": ["그때그아인"]}, {"singer": "김현정", "songs": ["그녀와의이별", "멍", "혼자한사랑"]}, {"singer": "나비/Navi", "songs": ["길에서"]},
    ...
    {"singer": "솔지", "songs": ["계절의끝에서", "사랑스런너의곁에"]}, {"singer": "송하예", "songs": ["니소식", "새사랑"]}, {"singer": "송이한", "songs": ["밝게빛나는별이되어비춰줄게"]},
    ...
    {"singer": "임창정", "songs": ["소주한잔"]}, {"singer": "잔나비", "songs": ["주저하는연인들을위해"]}, {"singer": "임형주", "songs": ["천개의바람이되어"]},
    {"singer": "장나라", "songs": ["나도여자랍니다", "천애지아(하늘끝에이르는바람, 동이 OST)", "Sweet Dream/스윗드림"]}, {"singer": "장범준", "songs": ["흔들리는꽃들속에서네샴푸향이느껴진거야"]},
    {"singer": "장혜진", "songs": ["아름다운날들"]}, {"singer": "정경화", "songs": ["지상에서영원으로"]}, {"singer": "정은지", "songs": ["그대라구요", "하늘바라기"]},
    {"singer": "정인", "songs": ["장마"]}, {"singer": "정준일", "songs": ["안아줘"]}, {"singer": "제아", "songs": ["미아", "하모니/이영현"]},
    {"singer": "조승우", "songs": ["꽃이피고지듯이(사도 OST)"]}, {"singer": "조항조", "songs": ["가지마", "후"]}, {"singer": "지동국", "songs": ["돌아가는길"]},
    {"singer": "지아", "songs": ["가끔", "감기때문에", "그대만보여요", "그런다면서", "그런줄알았어", "그립습니다", "난행복해", "낡은옷", "너를기억한다", "누군가의무엇이되어", "눈물", "더만나봤자뭐해", "먼발치", "물끄러미", "물론", "뭉클", "바이올린", "사랑만알아서", "사랑해미안해", "술한잔해요", "술한잔해요오늘", "엄마미안해요", "우두커니", "웃게해줄게", "웃어줄래", "웃음만", "인형", "터질것같아", "헤어진첫날", "The Day/더데이", "Only One/온리원"]},
...
const trot = [{"singer": "강민주", "songs": ["회룡포"]}, {"singer": "강진", "songs": ["땡벌", "마부", "붓"]}, {"singer": "강혜연", "songs": ["와요와요"]},
    ...
    {"singer": "백난아", "songs": ["찔레꽃"]}, {"singer": "백설희", "songs": ["봄날은간다"]}, {"singer": "서정아", "songs": ["비비각시"]}, {"singer": "서주경", "songs": ["쓰러집니다"]},
    {"singer": "서지오", "songs": ["하니하니"]}, {"singer": "소유미", "songs": ["알랑가몰라", "흔들어주세요"]}, {"singer": "송가인", "songs": ["가인이어라", "무명배우", "서울의달", "엄마아리랑", "트로트가나는좋아요"]},
...
const newUpdate = ["금잔디 - 당신은 명작", "김현정 - 혼자한 사랑", "남승민 - 바보같은 사람", "솔지 - 사랑스런 너의 곁에", "이선희 - 소녀의 기도", "임영웅 - 아버지", "임창정 - 소주 한 잔"];
