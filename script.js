...
const trot = [{"singer": "강민주", "songs": ["회룡포"]}, {"singer": "강진", "songs": ["땡벌", "붓"]},
    ...
    {"singer": "홍자", "songs": ["눈물의술잔", "혼잣말"]}, {"singer": "홍지윤", "songs": ["오라"]},
...
const mrTrot = [{"singer": "김호중", "songs": ["고맙소", "너나나나", "살았소", "태클을걸지마", "할무니"]},
    ...
    {"singer": "임영웅", "songs": ["가슴은알죠/나예원", "다시만날수있을까", "무지개", "바램", "별빛같은나의사랑아", "보랏빛엽서", "사랑은늘도망가/이문세", "사랑이이런건가요", "어느날문득", "오래된노래", "우리들의블루스", "이제나만믿어요", "일편단심민들레야"]},
...
const old = [{"singer": "강수지", "songs": ["시간속의향기"]}, {"singer": "강승모", "songs": ["무정부르스"]},
    ...
    {"singer": "이선희", "songs": ["그대손놓아요", "그중에그대를만나", "나항상그대를", "라일락이질때", "바람꽃", "아름다운강산", "알고싶어요", "여우비", "인연", "추억의책장을넘기면"]},
...
const newUpdate = ["가비엔제이 - 핼쑥해졌대", "박길라 - 나무와 새", "이선의 - 바람꽃", "임영웅 - 다시 만날 수 있을까", "임영웅 - 무지개", "임영웅 - 우리들의 블루스", "홍자 - 혼잣말"];
