const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    ...
    {"singer": "남규리", "songs": ["깊은밤을날아서"]}, {"singer": "노라조", "songs": ["변비", "형"]},
    {"singer": "노을", "songs": ["늦은밤너의집앞골목길에서", "청혼"]},
    {"singer": "도원경", "songs": ["다시사랑한다면"]}, {"singer": "도은영", "songs": ["그래도사랑해요"]},
    {"singer": "다비치", "songs": ["거북이", "그냥안아달란말야", "그대니까요", "꿈처럼내린", "나의오랜연인에게", "남자도우나요", "너라서", "너없는시간들", "너에게못했던내마지막말은", "또운다또", "모르시나요", "미워도사랑하니까", "사고쳤어요", "사랑과전쟁", "슬픈다짐", "시간아멈춰라", "여성시대", "오늘도그리워그리워", "오로지그대", "이사랑", "화이트/WHITE", "8282"]},
    {"singer": "더리슨(솔지x김나영x케이시x승희xHYNN)/박혜원", "songs": ["느린이별"]}, {"singer": "란", "songs": ["어쩌다가"]},
    {"singer": "럼블피쉬", "songs": ["비와당신"]}, {"singer": "리즈/Leeds", "songs": ["그댄행복에살텐데"]},
    ...
    {"singer": "먼데이키즈/Monday Kiz", "songs": ["가을안부", "그대여", "사랑이식었다고말해도돼"]}, {"singer": "모세", "songs": ["사랑인걸"]},
    ...
    {"singer": "솔지", "songs": ["계절의끝에서"]}, {"singer": "송하예", "songs": ["니소식", "새사랑"]},
    {"singer": "송이한", "songs": ["밝게빛나는별이되어비춰줄게"]}, {"singer": "신승훈", "songs": ["미소속에비친그대"]},
    {"singer": "신예영", "songs": ["우리왜헤어져야해"]}, {"singer": "신현희와김루트", "songs": ["오빠야"]},
    ...
    {"singer": "유성은", "songs": ["그대꽃"]}, {"singer": "유정석", "songs": ["질풍가도"]},
    {"singer": "유재하", "songs": ["사랑하기때문에"]}, {"singer": "유주", "songs": ["호랑수월가(나와호랑이님 OST)"]},
    {"singer": "유해준", "songs": ["나에게그대만이", "내소중한사람에게"]},
    ...
    {"singer": "이보람/씨야", "songs": ["처음그자리에(풀하우스 OST)"]}, 
...
const trot = [{"singer": "강민주", "songs": ["회룡포"]}, {"singer": "강진", "songs": ["땡벌", "붓"]},
    ...
    {"singer": "안소미", "songs": ["술한잔"]}, {"singer": "양지은", "songs": ["그강을건너지마오", "붓"]},
    {"singer": "오승근", "songs": ["내나이가어때서", "있을때잘해"]}, {"singer": "오은주", "songs": ["돌팔매"]},
    {"singer": "요요미", "songs": ["이오빠뭐야"]}, {"singer": "우연이", "songs": ["우연히"]},
    {"singer": "윙크", "songs": ["얼쑤"]},  {"singer": "유산슬", "songs": ["사랑의재개발", "합정역5번출구"]},
    {"singer": "유지나", "songs": ["미운사내"]}, {"singer": "유진표", "songs": ["천년지기"]},
    {"singer": "윤수일", "songs": ["아파트"]}, {"singer": "윤수현", "songs": ["꽃길", "손님온다", "천태만상"]},
    ...
    {"singer": "장윤정", "songs": ["꽃", "너떠난후에", "다시한번", "당신편", "돼지토끼", "목포행완행열차", "바람길", "반창고", "버팀목", "벚꽃길", "불나비", "사랑아", "사랑참", "세월아", "송인", "애가타", "약속", "어머나", "어부바", "옆집누나", "올래", "운명에게", "이정표", "장윤정트위스트", "좋은당신", "짠짜라", "첫사랑", "초혼", "케세라세라", "콩깍지", "해바라기"]},
...
const mrTrot = [{"singer": "김호중", "songs": ["고맙소", "너나나나", "살았소", "태클을걸지마", "할무니"]},
    ...
    {"singer": "임영웅", "songs": ["가슴은알죠/나예원", "바램", "별빛같은나의사랑아", "보랏빛엽서", "사랑은늘도망가/이문세", "사랑이이런건가요", "어느날문득", "오래된노래", "이제나만믿어요", "일편단심민들레야"]},
...
const old = [{"singer": "강수지", "songs": ["시간속의향기"]}, {"singer": "강승모", "songs": ["무정부르스"]},
    ...
    {"singer": "박기영", "songs": ["마지막사랑"]}, {"singer": "박성신", "songs": ["한번만더"]},
...
const newUpdate = ["임영웅 - 오래된 노래", "장윤정 - 버팀목", "장윤정 - 이정표", "리즈 - 그댄 행복에 살텐데", "먼데이키즈 - 가을 안부", "먼데이키즈 - 사랑이 식었다고 말해도 돼"];
