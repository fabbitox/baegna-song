const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    ...
    {"singer": "강민경", "songs": ["사랑해서그래"]}, {"singer": "거미", "songs": ["그대돌아오면", "그대라서", "기억해줘요내모든날과그때를", "날그만잊어요", "너의하루는좀어때", "눈꽃", "아니", "어른아이", "죽어도사랑해", "지워져", "친구라도될걸그랬어", "통증", "혼자만하는사랑", "You are my everything/유아마이에브리띵"]},
    {"singer": "공소원", "songs": ["모래알사랑"]}, {"singer": "김규랑", "songs": ["하지마요"]}, {"singer": "김길중", "songs": ["사랑했지만"]},
    ...
    {"singer": "김아중", "songs": ["마리아"]}, {"singer": "김윤아(자우림)", "songs": ["길(시그널 OST)", "스물다섯, 스물하나", "야상곡", "있지"]},
    {"singer": "김진호", "songs": ["가족사진"]}, {"singer": "김연지(씨야)", "songs": ["Whisky on the Rock/위스키온더락"]},
    {"singer": "김현정", "songs": ["그녀와의이별", "멍"]}, {"singer": "나비/Navi", "songs": ["길에서"]}, {"singer": "남규리", "songs": ["깊은밤을날아서"]},
    {"singer": "노라조", "songs": ["변비", "형"]}, {"singer": "노을", "songs": ["늦은밤너의집앞골목길에서", "청혼"]}, {"singer": "도원경", "songs": ["다시사랑한다면"]},
    ...
    {"singer": "럼블피쉬", "songs": ["비와당신"]}, {"singer": "로이킴", "songs": ["그때헤어지면돼"]}, {"singer": "리즈/Leeds", "songs": ["그댄행복에살텐데"]},
    {"singer": "리지", "songs": ["쉬운여자아니에요"]}, {"singer": "린", "songs": ["곰인형", "돌팔매/사랑의콜센타", "알아요(연모 OST)", "사랑했잖아", "시간을거슬러", "실화", "이별살이", "자기야여보야사랑아"]},
    ...
    {"singer": "박효신", "songs": ["사랑한후에"]}, {"singer": "백아연", "songs": ["이럴거면그러지말지"]}, {"singer": "백지영", "songs": ["거짓말이라도해서널보고싶어", "그대의마음", "나쁜사람(황진이 OST)", "다시는사랑하지않고이별에아파하기싫어", "사랑안해", "사랑하나면돼", "잊지말아요", "총맞은것처럼"]},
    ...
    {"singer": "설하윤", "songs": ["내인생의봄처럼꽃은핀다(세상에서제일예쁜내딸 OST)"]}, {"singer": "소녀시대", "songs": ["다시만난세계", "소녀시대", "Kissing You/키싱유"]},
    {"singer": "수지", "songs": ["겨울아이"]}, {"singer": "소찬휘", "songs": ["일엽락", "Tears/티어스/티얼스"]}, {"singer": "소향", "songs": ["가슴만알죠", "나언젠간떠날거야(모아나 OST)", "바람의노래/조용필", "오직단하나(마의 OST)", "Sweet Dreams, My Dear(로스트아크 OST)"]},
    {"singer": "솔지", "songs": ["계절의끝에서"]}, {"singer": "송하예", "songs": ["니소식", "새사랑"]}, {"singer": "송이한", "songs": ["밝게빛나는별이되어비춰줄게"]},
    {"singer": "스페이스에이/Space A", "songs": ["Again/어게인"]}, {"singer": "신승훈", "songs": ["미소속에비친그대"]}, {"singer": "신예영", "songs": ["우리왜헤어져야해"]},
    {"singer": "신현희와김루트", "songs": ["오빠야"]}, {"singer": "심규선", "songs": ["밤의정원", "부디", "소로", "아라리", "야래향", "어떤날도어떤말도", "월령"]},
    {"singer": "씨야/SeeYa", "songs": ["결혼할까요", "구두", "그사람(구두3)", "그사람이나를사랑해요", "눈물의여왕", "미워요", "미친사랑의노래", "사랑의인사", "슬픈발걸음(구두 2)", "얼음인형", "여인의향기", "정", "Promise U/프로미스유", "The Day/더데이/브라운아이드걸스", "The Last/더라스트"]},
    ...
    {"singer": "이승기", "songs": ["내여자라니까", "되돌리다", "삭제", "여행을떠나요"]}, {"singer": "이승철", "songs": ["서쪽하늘"]}, 
    {"singer": "이안", "songs": ["물고기자리"]}, {"singer": "이예준", "songs": ["그날에나는맘이편했을까", "그리워그리워", "미친소리"]},
    ...
    {"singer": "인순이", "songs": ["아버지"]}, {"singer": "임정희", "songs": ["눈물이안났어", "사랑아가지마"]}, {"singer": "임재범", "songs": ["고해", "낙인(추노 OST)"]},
    {"singer": "잔나비", "songs": ["주저하는연인들을위해"]}, {"singer": "임형주", "songs": ["천개의바람이되어"]}, {"singer": "장나라", "songs": ["나도여자랍니다", "천애지아(하늘끝에이르는바람, 동이 OST)", "Sweet Dream/스윗드림"]},
    {"singer": "장범준", "songs": ["흔들리는꽃들속에서네샴푸향이느껴진거야"]}, {"singer": "장혜진", "songs": ["아름다운날들"]},
    {"singer": "정경화", "songs": ["지상에서영원으로"]}, {"singer": "정은지", "songs": ["그대라구요", "하늘바라기"]}, {"singer": "정인", "songs": ["장마"]},
    {"singer": "정준일", "songs": ["안아줘"]}, {"singer": "제아", "songs": ["미아", "하모니/이영현"]}, {"singer": "조승우", "songs": ["꽃이피고지듯이(사도 OST)"]},
    {"singer": "조항조", "songs": ["가지마", "후"]}, {"singer": "지동국", "songs": ["돌아가는길"]}, {"singer": "지아", "songs": ["가끔", "감기때문에", "그대만보여요", "그런다면서", "그런줄알았어", "그립습니다", "난행복해", "낡은옷", "너를기억한다", "누군가의무엇이되어", "눈물", "더만나봤자뭐해", "먼발치", "물끄러미", "물론", "바이올린", "사랑만알아서", "사랑해미안해", "술한잔해요", "술한잔해요오늘", "엄마미안해요", "우두커니", "웃게해줄게", "웃어줄래", "웃음만", "인형", "터질것같아", "헤어진첫날", "The Day/더데이", "Only One/온리원"]},
    {"singer": "차지연", "songs": ["그대는어디에", "살다보면"]}, {"singer": "케이시/Kassy", "songs": ["가을밤떠난너", "그때가좋았어", "너의발걸음에빛을비춰줄게", "언제나사랑해", "진심이담긴노래", "행복하니"]},
    {"singer": "코요태", "songs": ["우리의꿈(원피스)"]}, {"singer": "태연", "songs": ["그대라는시", "그리고하나", "내게들려주고싶은말", "들리나요", "만약에", "미치게보고싶은", "불티", "사계", "사랑해요", "숨겨진세상(겨울왕국2 OST)", "제주도의푸른밤", "Curtain Call/커튼콜", "Fine/파인", "I/아이", "Rain/레인"]},
    {"singer": "패티김", "songs": ["이별"]}, {"singer": "페이지", "songs": ["이별이오지못하게"]}, {"singer": "폴킴", "songs": ["모든날모든순간"]},
    {"singer": "플라이 투 더 스카이", "songs": ["가슴아파도"]}, {"singer": "허각", "songs": ["언제나"]}, {"singer": "황인욱", "songs": ["포장마차"]}, 
    {"singer": "HYNN/박혜원", "songs": ["시든꽃에물을주듯", "LET ME OUT/렛미아웃"]}, {"singer": "izi/이지", "songs": ["응급실/쾌걸춘향 OST"]},
    {"singer": "SG워너비", "songs": ["살다가"]}, {"singer": "Sondia/손디아", "songs": ["어른", "혼잣말"]}, {"singer": "TWICE/트와이스", "songs": ["Dance The Night Away/댄스더나잇어웨이"]},
    {"singer": "The One/더원", "songs": ["사랑아"]}, {"singer": "WSG워너비(가야G)", "songs": ["그때그시절그대로(그그그)"]},
...
const trot = [{"singer": "강민주", "songs": ["회룡포"]}, {"singer": "강진", "songs": ["땡벌", "마부", "붓"]}, {"singer": "강혜연", "songs": ["와요와요"]},
    {"singer": "곽지은", "songs": ["꽃으로"]}, {"singer": "금잔디", "songs": ["나를살게하는사랑", "서울가살자", "신사랑고개", "엄마의노래", "여여", "오라버니", "일편단심", "지름길", "초롱새"]},
    {"singer": "김다나", "songs": ["자시삼경"]}, {"singer": "김다비", "songs": ["주라주라"]}, {"singer": "김란영", "songs": ["가인"]},
    {"singer": "김소유", "songs": ["숫자인생"]}, {"singer": "김수희", "songs": ["남행열차", "애모"]}, {"singer": "김연자", "songs": ["밤열차", "블링블링", "수은등", "아모르파티", "타이틀", "10분내로"]},
    {"singer": "김용임", "songs": ["나이야가라", "내장산", "부초같은인생", "빙빙빙", "사랑님", "열두줄", "울지마라세월아", "훨훨훨"]},
    {"singer": "김의영", "songs": ["용두산엘레지"]}, {"singer": "김의영, 윤태화", "songs": ["비익조"]}, {"singer": "김지애", "songs": ["얄미운사람"]},
    {"singer": "김태연(이태호)", "songs": ["간대요글쎄"]}, {"singer": "김혜연", "songs": ["예쁜여우", "토요일밤에"]}, {"singer": "나훈아", "songs": ["고장난벽시계", "내게애인이생겼어요", "사내", "사모", "잡초", "테스형" , "홍시"]},
    {"singer": "남진", "songs": ["나야나", "님과함께", "둥지", "빈잔"]}, {"singer": "대성", "songs": ["대박이야"]}, {"singer": "류계영", "songs": ["인생"]},
    {"singer": "문희옥", "songs": ["사랑의거리", "평행선"]}, {"singer": "박군", "songs": ["한잔해"]}, {"singer": "박상철", "songs": ["무조건", "빵빵", "자옥아", "항구의남자", "황진이"]},
    {"singer": "박현빈", "songs": ["곤드레만드레", "샤방샤방"]}, {"singer": "백난아", "songs": ["찔레꽃"]}, {"singer": "백설희", "songs": ["봄날은간다"]},
    {"singer": "서정아", "songs": ["비비각시"]}, {"singer": "서주경", "songs": ["쓰러집니다"]}, {"singer": "서지오", "songs": ["하니하니"]},
    {"singer": "소유미", "songs": ["알랑가몰라"]}, {"singer": "송가인", "songs": ["가인이어라", "무명배우", "서울의달", "엄마아리랑", "트로트가나는좋아요"]},
    {"singer": "송대관", "songs": ["네박자", "차표한장"]}, {"singer": "숙행", "songs": ["가시리"]}, {"singer": "신유", "songs": ["나쁜남자", "시계바늘", "일소일소일노일노", "잠자는공주"]},
    {"singer": "심수봉", "songs": ["그때그사람", "미워요", "백만송이장미", "비나리", "사랑밖엔난몰라", "젊은태양"]}, {"singer": "안소미", "songs": ["술한잔"]},
    {"singer": "양지은", "songs": ["그강을건너지마오", "붓"]}, {"singer": "오승근", "songs": ["내나이가어때서", "있을때잘해"]}, {"singer": "오은주", "songs": ["돌팔매"]},
    {"singer": "요요미", "songs": ["이오빠뭐야", "주연배우"]}, {"singer": "우연이", "songs": ["우연히"]}, {"singer": "윙크", "songs": ["얼쑤"]},
    {"singer": "유산슬", "songs": ["사랑의재개발", "합정역5번출구"]}, {"singer": "유지나", "songs": ["미운사내"]}, {"singer": "유진표", "songs": ["천년지기"]},
    {"singer": "윤수일", "songs": ["아파트"]}, {"singer": "윤수현", "songs": ["꽃길", "손님온다", "천태만상"]}, {"singer": "이미자", "songs": ["노래는나의인생", "동백아가씨", "섬마을선생님", "아씨", "여로"]},
    {"singer": "이상은", "songs": ["언젠가는"]}, {"singer": "이이경", "songs": ["칼퇴근"]}, {"singer": "이자연", "songs": ["당신의의미", "찰랑찰랑"]},
    {"singer": "이효정", "songs": ["우리어머니"]}, {"singer": "이혜리", "songs": ["모르나봐", "자갈치아지매"]}, {"singer": "임주리", "songs": ["립스틱짙게바르고"]},
    {"singer": "장윤정", "songs": ["꽃", "내사랑로미오", "너떠난후에", "다시한번", "당신편", "돼지토끼", "목포행완행열차", "바람길", "반창고", "버팀목", "벚꽃길", "불나비", "사랑아", "사랑참", "세월아", "송인", "애가타", "약속", "어머나", "어부바", "옆집누나", "올래", "운명에게", "이정표", "장윤정트위스트", "좋은당신", "짠짜라", "첫사랑", "초혼", "케세라세라", "콩깍지", "해바라기"]},
    {"singer": "정다경", "songs": ["가라그래"]}, {"singer": "전미경", "songs": ["장녹수"]}, {"singer": "정수라", "songs": ["도라지꽃"]},
    {"singer": "정은실", "songs": ["은실이"]}, {"singer": "정의송", "songs": ["님이여"]}, {"singer": "조은새", "songs": ["하트하트"]},
    ...
    {"singer": "홍자", "songs": ["눈물의술잔", "혼잣말"]}, {"singer": "홍지윤", "songs": ["오라"]}, {"singer": "홍진영", "songs": ["그대오는날", "내사랑", "눈물비", "달의그림자/클랜즈:달의그림자 OST", "따르릉", "부기맨", "비바라비다", "사랑은꽃잎처럼", "사랑은다이러니", "사랑의배터리", "사랑의와이파이", "사랑이좋아", "산다는건", "안돼요", "엄지척", "오늘밤에", "잘가라"]},
...
const newUpdate = ["김범수 - 보고 싶다", "김연자 - 밤열차", "김연지(씨야) - Whisky on the Rock", "설하윤 - 내 인생의 봄처럼 꽃은 핀다(세상에서 제일 예쁜 내 딸 OST)", "소향 - Sweet Dreams, My Dear(로스트아크 OST)", "장윤정 - 내사랑 로미오", "WSG워너비(가야G) - 그때 그 순간 그대로(그그그)"];
