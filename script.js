const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    ...
    {"singer": "민서/MINSEO", "songs": ["좋아"]}, {"singer": "바이걸", "songs": ["내이름은여자"]},
    {"singer": "박미경", "songs": ["기억속의먼그대에게", "민들레홀씨되어"]}, {"singer": "박보람(동물원)", "songs": ["혜화동(쌍문동)"]},
    {"singer": "박효신", "songs": ["사랑한후에"]}, {"singer": "백아연", "songs": ["이럴거면그러지말지"]},
    ...
    {"singer": "송이한", "songs": ["밝게빛나는별이되어비춰줄게"]}, {"singer": "스페이스에이/Space A", "songs": ["Again/어게인"]},
    {"singer": "신승훈", "songs": ["미소속에비친그대"]},
    {"singer": "신예영", "songs": ["우리왜헤어져야해"]}, {"singer": "신현희와김루트", "songs": ["오빠야"]},
    {"singer": "심규선", "songs": ["밤의정원", "부디", "소로", "아라리", "야래향", "어떤날도어떤말도", "월령"]},
    {"singer": "씨야/SeeYa", "songs": ["결혼할까요", "구두", "그사람이나를사랑해요", "눈물의여왕", "미워요", "미친사랑의노래", "사랑의인사", "슬픈발걸음(구두2)", "얼음인형", "여인의향기", "정", "Promise U/프로미스유", "The Day/더데이/브라운아이드걸스", "The Last/더라스트"]},
...
const newUpdate = ["민서(MINSEO) - 좋아", "스페이스 에이(Space A) - Again", "씨야(SeeYa) - 결혼할까요"];
