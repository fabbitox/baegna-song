const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    ...
    {"singer": "김필", "songs": ["그때그아인"]}, {"singer": "김현정", "songs": ["그녀와의이별", "멍"]}, {"singer": "나비/Navi", "songs": ["길에서"]},
    {"singer": "남규리", "songs": ["깊은밤을날아서"]}, {"singer": "노라조", "songs": ["변비", "형"]}, {"singer": "노사연", "songs": ["바램"]},
    ...
    {"singer": "윤종신", "songs": ["좋니"]}, {"singer": "윤하", "songs": ["기다리다", "비밀번호486", "사건의지평선", "오늘헤어졌어요", "혜성"]},
...
const mrTrot = [{"singer": "김호중", "songs": ["고맙소", "너나나나", "살았소", "태클을걸지마", "할무니"]},
    ...
    {"singer": "임영웅", "songs": ["가슴은알죠/나예원", "다시만날수있을까", "무지개", "별빛같은나의사랑아", "보랏빛엽서", "사랑은늘도망가/이문세", "사랑이이런건가요", "어느날문득", "오래된노래", "우리들의블루스", "이제나만믿어요", "일편단심민들레야"]},
...
const newUpdate = ["거미 - 구르미 그린 달빛", "김필 - 그때 그 아인", "아이유 - 드라마", "윤하 - 사건의 지평선"];
