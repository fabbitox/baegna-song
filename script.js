const title = [{"singer": "배그나(은하수)", "songs": ["나란여자", "내사랑구례", "너라는마법", "뚝뚝뚝", "못참아", "소꿉친구", "숨겨온마음", "안돼요돼요", "애태우다", "옛사랑", "이말전할수있을까", "좋아요", "팽이같은인생"]},
    ...
    {"singer": "김아중", "songs": ["마리아"]}, {"singer": "김양", "songs": ["가시오"]}, {"singer": "김윤아(자우림)", "songs": ["길(시그널 OST)", "스물다섯, 스물하나", "야상곡", "있지"]},
...
const trot = [{"singer": "강민주", "songs": ["회룡포"]}, {"singer": "강진", "songs": ["땡벌", "마부", "붓"]}, {"singer": "강혜연", "songs": ["와요와요"]},
    ...
    {"singer": "소유미", "songs": ["알랑가몰라", "흔들어주세요"]}, {"singer": "송가인", "songs": ["가인이어라", "무명배우", "서울의달", "엄마아리랑", "트로트가나는좋아요"]},
...
const newUpdate = ["김양 - 가시오", "김연자 - 영동 부르스", "소유미 - 흔들어주세요", "장민호 - 저어라", "최연재 - 너의 마음을 내게 준다면"];
